...
class Updater {
  ...
  checkForUpdates() {
    ...
    // En modo desarrollo, no mostrar mensaje de actualizaciones
    if (!app.isPackaged) {
      return;
    }

    // electron-updater maneja automáticamente la configuración desde package.json
    // No es necesario verificar app-update.yml manualmente
